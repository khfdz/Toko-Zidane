...
//     // Simpan cart yang disimpan ke database
//     await cartSave.save();
...
const saveCart = async (req, res) => {
  ...
  try {
    ...
    const cartSave = new CartSave({
      ...
      subTotal: cart.subTotal,
      totalPrice: cart.totalPrice,
      customerName: cart.customerName // Tambahkan ini
    });
...
const loadCart = async (req, res) => {
  ...
  try {
    ...
    cart.subTotal = cartSave.subTotal;
    cart.totalPrice = cartSave.totalPrice;
    cart.customerName = cartSave.customerName; // Tambahkan ini
